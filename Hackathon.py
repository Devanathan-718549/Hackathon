...
def printResult(array):
    ...
    for i in array:
        row = row + 1
        if i == 1:
            print("Row {} result : {}".format(row, "Not Fraud"))
        else:
            print("Row {} result : {}".format(row, "Fraud"))
config = getConfig()
...
print("KNN Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("KNN Predictions End *******")

#LGG
alg = LogisticRegression()
alg.fit(xTrainingData, yTrainingPredictonResult)
predictions = alg.predict(xValidation)
print("LogisticRegression Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("LogisticRegression Predictions End *******")

#DT
alg = DecisionTreeClassifier()
alg.fit(xTrainingData, yTrainingPredictonResult)
predictions = alg.predict(xValidation)
print("DecisionTreeClassifier Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("DecisionTreeClassifier Predictions End *******")

#LinearDiscriminantAnalysis
alg = LinearDiscriminantAnalysis()
alg.fit(xTrainingData, yTrainingPredictonResult)
predictions = alg.predict(xValidation)
print("LinearDiscriminantAnalysis Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("LinearDiscriminantAnalysis Predictions End *******")

#GaussianNB
alg = GaussianNB()
alg.fit(xTrainingData, yTrainingPredictonResult)
predictions = alg.predict(xValidation)
print("GaussianNB Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("GaussianNB Predictions End *******")

#SVC
alg = SVC()
alg.fit(xTrainingData, yTrainingPredictonResult)
predictions = alg.predict(xValidation)
print("SVC Predictions Start *******")
printResult(predictions)
print("predictions {}".format(predictions))
print("accuracy {}".format(accuracy_score(yvalidation, predictions)))
print("SVC Predictions End *******")